...
const BarRecbMensal = () => {
    ...
    const mockData = {
        ...
        series: [
            {
                name: "Kg Recebidos",
                data: [108468, 113628,	123526, 138370, 186067, 187866, 219556, 162479, 257534, 204908, 255846, 235632, 170503, 177506, 183005, 129727, 151077, 156492, 180520, 189042, 220864, 139278, 2174672, 638948, 3023874, 2740832, 3233508, 853734, 154182]                  
            }
        ]
    };
